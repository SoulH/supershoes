...
namespace App
{
    ...
    public class ApplicationUserManager : UserManager<ApplicationUser>
    {
        ...
        {
            var url = string.Join("/", ConfigurationManager.AppSettings["API_URL"], "account", "register");
            ...
            if (response.IsSuccessStatusCode)
            {
                ...
                return new IdentityResult(content.ErrorMessage);
            }
            return new IdentityResult("Server Error");
        }
    }
    ...
    public class ApplicationSignInManager : SignInManager<ApplicationUser, string>
    {
        ...
        public override async Task<SignInStatus> PasswordSignInAsync(string userName, string password, bool isPersistent, bool shouldLockout)
        {
            ...
            {
                var content = await response.Content.ReadAsAsync<ResponseModel<UserModel>>();
                if (content.Success && content.Data[0].Username == userName)
